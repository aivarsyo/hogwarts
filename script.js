...
function popModal(studentName) {
    ...
    if (filteredStudent.house == "Slytherin") {
        modalbg.style.backgroundImage = "url(images/slytherin-bck.png)";
    } else if (filteredStudent.house == "Gryffindor") {
        modalbg.style.backgroundImage = "url(images/gryfindor-bck.jpg)";
    } else if (filteredStudent.house == "Hufflepuff") {
        modalbg.style.backgroundImage = "url(images/hufflepuff-bck.jpg)";
    } else if (filteredStudent.house == "Ravenclaw") {
        modalbg.style.backgroundImage = "url(images/ravenclaw-bck.jpg)";
    }
...
function expell() {
    for (let counter = 0; counter < usableData.length; counter++) {
        if (usableData[counter].firstname === "Aivars") {
    ...
    if (event.target.value === "Aivars") {
        ...
        modal.classList.add("hide");
        displayData(filteredData);
        document.querySelector("#expelledModal").style.display = "flex";
        document.querySelector(".closeExpelled").addEventListener("click", function () {
...
function hackTheSystem() {
    ...
    me.firstname = "Aivars";
    me.lastname = "Lejnieks";
    me.nickname = "aivarsyo";
    me.house = "Gryffindor";
